...
if __name__ == "__main__":
    ...
    checkpoint = torch.load("../data/checkpoint/ckpt_resnet18_imagenet16.pth")
    model.load_state_dict(checkpoint['net'])
    model.eval()
    ds = get_dataset("imagenet16")
    ...
    plt.plot(rate_range, ret, label="random")
    ...
    plt.plot(rate_range, ret, label="TS")
    #
    plt.legend()
    
    plt.savefig("./results/FT_imagenet_random_TS.pdf", bbox_inches="tight", dpi=500)
