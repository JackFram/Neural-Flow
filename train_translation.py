...
def train_wmt16(model, tokenizer, logger, raw_datasets, model_args, data_args, training_args, mode="train"):
...
def main():
    ...
    training_args.source_prefix = "translate English to Romanian: "
